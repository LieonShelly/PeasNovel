//
//  BUNativeFeedTableViewCell.swift
//  PeasNovel
//
...
class BUNativeFeedTableViewCell: UITableViewCell, BUNativeProtocol {
    ...
    func config(_ native: BUNativeAd) {
        ...
        native.registerContainer(contentView, withClickableViews: [adImage, detailBtn, icon, titleLabel, subTitleLabel])
