...
class DZMRMSettingView: DZMRMBaseView {
    ...
    override func addSubviews() {
        ...
        // 颜色
        colorView = DZMRMColorView(frame:CGRect(x: 0, y: 0, width: ScreenWidth, height: 54),readMenu:readMenu,colors:DZMReadBGColors,selectIndex:DZMReadConfigure.shared().colorIndex)
...
//        addSubview(fontView)
        ...
        // 字体大小
        fontSizeView = DZMRMFuncView(frame:CGRect(x: 0, y: effectView.frame.maxY, width: ScreenWidth, height: funcViewH), readMenu:readMenu, funcType: .fontSize, title:"字号")
