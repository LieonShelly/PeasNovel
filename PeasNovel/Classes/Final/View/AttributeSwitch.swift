...
@IBDesignable open class AttributeSwitch: UIControl {
    ...
    @IBInspectable open var offTintColor: UIColor = UIColor(red: 0.3, green: 0.85, blue: 0.39, alpha: 1) {
        willSet {
            if !self.on && !self.isTracking {
                backgroundView.backgroundColor = newValue
                backgroundView.layer.borderColor = newValue.cgColor
    ...
    fileprivate func setup() {
        ...
        thumbLabel = UILabel(frame: thumbImageView.frame)
    ...
    override open func layoutSubviews() {
        ...
        if !isAnimating {
            ...
            thumbLabel.frame = CGRect(x: 0, y: 0, width: normalKnobWidth, height: normalKnobWidth)
