...
class ImageListView: UIView {
    ...
    struct UISize {
        static let singleImageWidth: CGFloat = UIScreen.main.bounds.width - 62 - 16
    ...
    func config(_ imageCount: Int, fetchImageHandler: ((UIImageView?, Int) -> Void)?) {
        ...
        for index in (0 ..< imageCount) {
            ...
            if imageCount == 1 {
                let singleSize = CGSize(width: UISize.singleImageWidth, height: UISize.singleImageWidth) /// 暂时这么写
